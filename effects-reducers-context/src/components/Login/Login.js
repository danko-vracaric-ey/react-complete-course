...
const Login = (props) => {
  ...
  }, [enteredEmail, enteredPassword]); //everytime a useEffect function runs, before it runs except the first time this cleanup function will run and it will run whenever comp unmounts
